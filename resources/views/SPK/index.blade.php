            ...
            <div class="table-responsive">
                <div class="d-flex align-items-center justify-content-between mt-2 mb-3">
                    ...
                    href="{{ route('dashboard') }}">
                        {!! file_get_contents('icons/arrow-circle-left.svg') !!} Kembali
                    </a>
                                    ...
                                    <form action="{{ url('dashboard-edit-spk', $spkview->spk_id) }}" method="POST">
                                        ...
                                        @if ($spkview->spkMesin != null)
                                            <div class="form-group row">
                                                <div class="col">
                                                    ...
                                                    <input type="input" class="form-control" placeholder="Kirim"
                                                        name="kirim" value="{{ $spkview->spkMesin->kirim }}">
                                                </div>
                                                <div class="col-auto">
                                                    <label>Ekspedisi</label>
                                                    <input type="text" class="form-control" placeholder="Ekspedisi"
                                                        name="ekspedisi" value="{{ $spkview->spkMesin->ekspedisi }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="radio-button-container d-flex justify-content-between row">
                                                    <div class="button col p-0">
                                                        ...
                                                        {{ str_contains($spkview->spkMesin->finishing->finishing, 'Foil') ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Potong Jadi"
                                                    name="potong_jadi"
                                                    value="{{ $spkview->spkMesin->finishing->potong_jadi }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Keterangan</label>
                                                <input type="text" class="form-control" placeholder="Keterangan"
                                                    name="keterangan"
                                                    value="{{ $spkview->spkMesin->finishing->keterangan }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Nama Bahan</label>
                                                <input type="text" class="form-control" placeholder="Nama Bahan"
                                                    name="nama_bahan"
                                                    value="{{ $spkview->spkMesin->bahan->nama_bahan }}">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        @elseif($spkview->spkNota != null)
                                            <div class="form-group">
                                                <label>Nama Bahan</label>
                                                <input type="text" class="form-control" placeholder="Nama Bahan"
                                                    name="nama_bahan" value="{{ $spkview->spkNota->nama_bahan }}">
                                            </div>
                                            <div class="row">
                                                <div class="form-group col">
                                                    <label>Tebal Bahan</label>
                                                    <input type="text" class="form-control" placeholder="Tebal Bahan"
                                                        name="tebal_bahan" value="{{ $spkview->spkNota->tebal_bahan }}">
                                                </div>
                                                <div class="form-group col">
                                                    <label>Ukuran</label>
                                                    <input type="text" class="form-control" placeholder="Ukuran"
                                                        name="ukuran" value="{{ $spkview->spkNota->ukuran }}">
                                                </div>
                                                <div class="form-group col">
                                                    <label>Jumlah Cetak</label>
                                                    <input type="text" class="form-control" placeholder="Jumlah cetak"
                                                        name="jumlah_cetak"
                                                        value="{{ $spkview->spkNota->jumlah_cetak }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Rangkap"
                                                    name="rangkap" value="{{ $spkview->spkNota->rangkap }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Warna Rangkap</label>
                                                <input type="text" class="form-control" placeholder="Warna Rangkap"
                                                    name="warna_rangkap" value="{{ $spkview->spkNota->warna_rangkap }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Cetak</label>
                                                <input type="text" class="form-control" placeholder="Cetak"
                                                    name="cetak" value="{{ $spkview->spkNota->cetak }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Warna</label>
                                                <input type="text" class="form-control" placeholder="Warna"
                                                    name="warna" value="{{ $spkview->spkNota->warna }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Finishing</label>
                                                <input type="text" class="form-control" placeholder="Finishing"
                                                    name="finishing" value="{{ $spkview->spkNota->finishing }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Numerator</label>
                                                <input type="text" class="form-control" placeholder="Numerator"
                                                    name="numerator" value="{{ $spkview->spkNota->numerator }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Keterangan</label>
                                                <input type="text" class="form-control" placeholder="Keterangan"
                                                    name="keterangan" value="{{ $spkview->spkNota->keterangan }}">
                                            </div>
